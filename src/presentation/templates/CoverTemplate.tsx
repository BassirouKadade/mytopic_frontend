  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="absolute inset-0">
        <div className="absolute -top-20 -right-20 size-[400px] rounded-full bg-primary/15 blur-[100px]" />
        <div className="absolute -bottom-32 -left-20 size-[350px] rounded-full bg-primary/10 blur-[80px]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-[500px] rounded-full bg-white/[0.02] blur-[60px]" />
      </div>
      ...
      <div className="relative flex h-full flex-col justify-between px-12 py-10">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6 px-8">
          <h1 className="text-[clamp(32px,4vw,56px)] font-bold leading-[1.05] tracking-[-0.04em] text-white max-w-4xl">
            {props.slide.title}
          </h1>

          {(props.presentation.presentation_subtitle || props.slide.purpose) && (
            <p className="text-[clamp(14px,1.5vw,18px)] leading-relaxed text-white/60 max-w-2xl">
              {props.presentation.presentation_subtitle || props.slide.purpose}
            </p>
          )}
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <span className="text-[11px] font-medium tracking-wider text-primary/80 uppercase">
              {props.presentation.target_audience || props.presentation.tone || ""}
            </span>
            <div className="h-px w-8 bg-primary/60" />
          </div>
        </div>
